...
用户已授权本规划任务逐 Gate 推进至阶段终态；Gate A 已 PASS，用户已确认全部科学配方；当前授权 Gate B 最小干预实现与双模型 debug。正式校准与 test 评测仍锁在后续 Gate。
[总体计划](phase8/loopscope_phase8_plan.md) / [科学合同](phase8/loopscope_phase8_contract_v1.md) / [Gate B handoff](phase8/loopscope_phase8_gate_b_handoff.md) / [易读阶段报告](../docs/loopscope_phase8.md)。
