#!/usr/bin/env python3
"""Build the gold-free 18-cell Phase 9 new-arm score manifest."""
...
from tflt.loopscope.phase9_accuracy import load_config, score_manifest, validate_score_manifest
...
def main() -> None:
    ...
    with args.output.open("x", encoding="utf-8") as handle:
        ...
        handle.write("\n")
    print(json.dumps({
        "status": "PHASE9_SCORE_MANIFEST_READY",
        "scope": value["scope"],
